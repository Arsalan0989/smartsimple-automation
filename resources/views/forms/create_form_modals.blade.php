...
<div style="display:none;"id="uiform-hidden-box-tools">
 <div class="uiform-newform-help-highlight">
	<span class="uifm-text-one"><?php echo __( 'Drag and Drop the fields to this area ' ); ?></span>
	<span class="uifm-text-two"><?php echo __( 'or just click the button fields to add it here ' ); ?></span>
	</div>   
	<div id="uiform-clogicgraph" title="<?php echo __( 'Conditional Logic graph' ); ?>"></div>
