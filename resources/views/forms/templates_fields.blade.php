 ...
 <script type="text/html" id="tmpl-zgpb-quick-options">
    ...
    <div class="zgpb-fields-quick-options">
        <div class="zgpb-fields-quick-options-wrap"> 
            <div class="zgpb-fields-quick-options-side1 zgpb-fields-qopt-color1">
                ...
                <a class="zgpb-fields-qopt-copy" title="Duplicate" onclick="javascript:rocketform.fields2_fieldQuickOptions_DuplicateField('');" href="javascript:void(0);">
                    <span class="zgpb-field-qopt-block"><i class="fa fa-files-o"></i></span>
                </a>
                    <a class="zgpb-fields-qopt-remove" title="Remove" onclick="javascript:rocketform.fields2_fieldQuickOptions_deleteField('');" href="javascript:void(0);">
    ...
    <div class="zgpb-fields-quick-options2">
        <div class="zgpb-fields-quick-options-wrap zgpb-fields-qopt-color3">
            <a class="zgpb-fields-qopt-move uiform-field-move" title="Move field block" href="javascript:void(0);">
                <span class="zgpb-field-qopt-block"><span><?php echo __( 'Field' ); ?></span> <i class="fa fa-arrows"></i></span>
            </a>
            <a class="zgpb-fields-qopt-edit" title="Edit" onclick="javascript:rocketform.fields2_fieldQuickOptions_EditField(this,true);" href="javascript:void(0);">
                    <span class="zgpb-field-qopt-block"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></span>
            </a>
						...
						<div class="uifm-control-label">
							<label class="sfdc-control-label">
							   ...
							   <span  data-field-store="label-text"
									  ...
									  class="uifm-label uifm-f-option"><?php echo __( 'Textbox label' ); ?></span>
							   <span data-field-store="sublabel-text"
									  data-field-option="uifm-sublabel"
									  class="uifm-sublabel uifm-f-option"><?php echo __( 'Textbox sublabel' ); ?></span>
							</label>
						</div>
					</div>
					...
					<div class="rkfm-col-sm-2">
						<div class="uifm-control-label">
							<label class="sfdc-control-label">
							   ...
							   <span  data-field-store="label-text"
									  data-field-option="uifm-label"
									  class="uifm-label uifm-f-option"><?php echo __( 'Textarea label' ); ?></span>
							   <span data-field-store="sublabel-text"
									  data-field-option="uifm-sublabel"
									  class="uifm-sublabel uifm-f-option"><?php echo __( 'Textarea sublabel' ); ?></span>
							</label>
								...
								<div class="sfdc-radio" data-inp2-opt-index="0">
									<label>
										<input class="uifm-inp2-rdo" type="radio"
											...
											name="" 
											 >
										<span class="uifm-inp2-label  uifm-input2-opt-main"><?php echo __( 'option' ); ?> 1</span>
									</label>
								 </div>
								<div class="sfdc-radio" data-inp2-opt-index="1">
									<label>
										<input class="uifm-inp2-rdo" type="radio"
											...
											name="" 
											>
										<span class="uifm-inp2-label  uifm-input2-opt-main"><?php echo __( 'option' ); ?> 2</span>
									</label>
								 </div>
								<div class="sfdc-radio" data-inp2-opt-index="2">
									<label>
										<input class="uifm-inp2-rdo" type="radio" 
											...
											name="" 
											 >
										<span class="uifm-inp2-label  uifm-input2-opt-main"><?php echo __( 'option' ); ?> 3</span>
									</label>
								 </div>
							</div>
						</div>
						...
						<div class="uifm-input-container">
							<div class="uifm-input2-wrap">
								<select class="sfdc-form-control uifm-input2-opt-main" >
									<option data-inp2-opt-index="0" > <?php echo __( 'option' ); ?> 1 </option> 
									<option data-inp2-opt-index="1"> <?php echo __( 'option' ); ?> 2 </option> 
									<option data-inp2-opt-index="2"> <?php echo __( 'option' ); ?> 3 </option> 
								</select>
							</div>
						</div>
						<div data-field-option="uifm-help-block"  class="uifm-help-block uifm-f-option">
						...
						<div class="uifm-input-container">
							<div class="uifm-fileinput-wrap">
								...
								<a href="#" class="sfdc-input-group-addon sfdc-btn sfdc-btn-default fileinput-exists" 
								   data-dismiss="fileinput"><?php echo __( 'Remove' ); ?></a>
								</div>
							</div>
						</div>
						<div data-field-option="uifm-help-block"  class="uifm-help-block uifm-f-option">
					...
					<div class="rkfm-col-sm-10">
						<div class="uifm-input-container">
								...
								<img width="175" 
									...
									title="CAPTCHA" 
									alt="CAPTCHA"
									src="{{ url('') }}/libs/uiform-lib-captcha.php?rkver=eyJjYV90eHRfZ2VuIjoiN3BmcTcifQ==" 
							...
							<div class="uifm-inp6-wrap-refrescaptcha">
									<a  title="Refresh captcha" 
										...
										data-rkurl="{{ url('') }}/libs/uiform-lib-captcha.php?rkver="
							...
							<div class="uifm-inp6-wrap-input-source"> 
								...
								<label for="rockfm-inp6-captcha-inputcode" 
									class="rockfm-inp6-captcha-label"><?php echo __( 'CAPTCHA Code' ); ?></label>
					...
					<div class="rkfm-col-sm-10">
						<div class="uifm-input-container">
							<div class="uifm-input-heading-wrap">
								<h1 class="uifm-txtbox-inp-val"><?php echo __( 'Type your heading H1 here' ); ?></h1>
							</div>
						</div>
						<div data-field-option="uifm-help-block"  style="display: none;" class="uifm-help-block uifm-f-option">
							<?php echo __( 'Help block text' ); ?>
			...
			<div class="uiform-field-wrap">
				<div class="rkfm-row">
					...
					<div class="rkfm-col-sm-12">
						<div class="uifm-input-container">
							<div class="uifm-input-heading-wrap">
								<h2 class="uifm-txtbox-inp-val"><?php echo __( 'Type your heading H2 here' ); ?></h2>
							</div>
						</div>
						<div data-field-option="uifm-help-block"  style="display: none;" class="uifm-help-block uifm-f-option">
							<?php echo __( 'Help block text' ); ?>
			...
			<div class="uiform-field-wrap">
				<div class="rkfm-row">
					...
					<div class="rkfm-col-sm-12">
						<div class="uifm-input-container">
							<div class="uifm-input-heading-wrap">
								<h3 class="uifm-txtbox-inp-val"><?php echo __( 'Type your heading H3 here' ); ?></h3>
							</div>
						</div>
						<div data-field-option="uifm-help-block"  style="display: none;" class="uifm-help-block uifm-f-option">
							<?php echo __( 'Help block text' ); ?>
			...
			<div class="uiform-field-wrap">
				<div class="rkfm-row">
					...
					<div class="rkfm-col-sm-12">
						<div class="uifm-input-container">
							<div class="uifm-input-heading-wrap">
								<h4 class="uifm-txtbox-inp-val"><?php echo __( 'Type your heading H4 here' ); ?></h4>
							</div>
						</div>
						<div data-field-option="uifm-help-block"  style="display: none;" class="uifm-help-block uifm-f-option">
							<?php echo __( 'Help block text' ); ?>
			...
			<div class="uiform-field-wrap">
				<div class="rkfm-row">
					...
					<div class="rkfm-col-sm-12">
						<div class="uifm-input-container">
							<div class="uifm-input-heading-wrap">
								<h5 class="uifm-txtbox-inp-val"><?php echo __( 'Type your heading H5 here' ); ?></h5>
							</div>
						</div>
						<div data-field-option="uifm-help-block"  style="display: none;" class="uifm-help-block uifm-f-option">
							<?php echo __( 'Help block text' ); ?>
			...
			<div class="uiform-field-wrap">
				<div class="rkfm-row">
					...
					<div class="rkfm-col-sm-12">
						<div class="uifm-input-container">
							<div class="uifm-input-heading-wrap">
								<h6 class="uifm-txtbox-inp-val"><?php echo __( 'Type your heading H6 here' ); ?></h6>
							</div>
						</div>
						<div data-field-option="uifm-help-block"  style="display: none;" class="uifm-help-block uifm-f-option">
							<?php echo __( 'Help block text' ); ?>
					...
					<div class="rkfm-col-sm-12">
						<div class="uifm-input-container">                               
							<button class="sfdc-btn uiform-btn-wizprev uifm-txtbox-inp13-val">
									...
									<div class="uifm-inp-lbl"><?php echo __( 'Prev' ); ?></div>
							</button>
							<button class="sfdc-btn uiform-btn-wiznext uifm-txtbox-inp12-val">
								   <div class="uifm-inp-lbl"><?php echo __( 'Next' ); ?></div>
	  ...
	  <div class="sfdc-modal-content">
		 ...
		 <div class="sfdc-modal-footer">
			<button type="button" class="sfdc-btn sfdc-btn-default" 
			   data-dismiss="modal"><?php echo __( 'Close' ); ?>
			</button>
		...
		<div class="sfdc-modal-content zgpb-scroll-pane-arrows">
		  <div class="sfdc-modal-header" >
			...
			<div class="zgpb-modal-header-inner">
				<img src="{{ url('') }}/assets/backend/image/ajax-loader-black.gif"/>
			</div>
		  </div>
...
<div style="display:none;">
	...
	<input type="hidden" id="zgpb_fld_del_box_title" value="<?php echo __( 'Delete field selected' ); ?>" >
	<input type="hidden" id="zgpb_fld_del_box_msg" value="<?php echo __( 'Are you sure?' ); ?>" >
	<input type="hidden" id="zgpb_fld_del_box_bt1_title" value="<?php echo __( 'Cancel' ); ?>" >
	<input type="hidden" id="zgpb_fld_del_box_bt2_title" value="<?php echo __( 'Yes' ); ?>" >
</div>
<div id="zgpb_confirmation-func-action-dialog" style="display: none;">
	<?php echo __( 'Are you sure about this?' ); ?>
</div>
		...
		<div class="sfdc-col-md-4">
			<div class="sfdc-form-group">
				<textarea id="uifm_frm_inp2_opt0_label"
							...
							placeholder="<?php echo __( 'Type label' ); ?>"  class="sfdc-form-control"></textarea>
			</div>
		</div>
		<div class="sfdc-col-md-4">
			<div class="sfdc-form-group">
					<textarea  
							...
							placeholder="<?php echo __( 'Type value' ); ?>"  class="sfdc-form-control"></textarea>  
			</div>
		</div>
		...
		<div class="sfdc-col-md-11">
			...
			<div class="sfdc-col-md-12 uifm_frm_inp17_opt_img_list_1">
				<div class="sfdc-col-md-12">
					...
					<i class="fa fa-plus-square"></i> <?php echo __( 'Add new' ); ?>
				</a>
						<div class="space10"></div>
